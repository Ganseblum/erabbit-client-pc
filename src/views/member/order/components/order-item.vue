    ...
    <div class="body">
      ...
      <div class="column action">
        ...
        <XtxButton
          ...
          type="primary"
          size="small"
          @click="$emit('on-receive', oreder)"
          >确认收货</XtxButton
        >
        <p>
          <a
            @click="$router.push(`/member/order/detail/${order.id}`)"
            href="javascript:;"
            >查看详情</a
          >
        </p>
...
export default {
  ...
  emits: ['on-cancel', 'on-delete', 'on-receive', 'on-logistics'],
  setup(props) {
