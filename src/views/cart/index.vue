    ...
    <div class="container">
      ...
      <div class="cart">
        <table>
          ...
          <!-- 有效商品 -->
          <tbody v-if="$store.getters['cart/validList']">
            <tr
      ...
      <div class="action">
        <div class="batch">
          ...
          <a class="green" href="javascript:;" @click="batchDeleteCart()"
            >删除</a
          >
...
export default {
  ...
  setup() {
    ...
    // 删除选中商品,清空失效商品
    const batchDeleteCart = (flag) => {
      Confirm({ text: `确认删除${flag ? '失效商品' : '选中商品'}` })
        .then(() => {
          store.dispatch('cart/batchDeleteCart', flag)
        })
        .catch((e) => {
          console.log('点击了取消')
        })
